...
engine=DBh.connect('mai1346','wo10who','127.0.0.1:3306','cnstock')
...
codes=close.columns[1:]

#print ts.adfuller(close['600909'],1)
#############################################
#method 1
t0 = time.time()
adfuller=close[close.columns[1:]].apply(ts.adfuller,maxlag=1)
...
hursts=close[close.columns[1:]].apply(hurst)
print hursts
